...
try:
    with sync_playwright() as p:
        ...
        wbad=[]
        IMPL={"overview","users","ai-providers","ai-route","ai-usage","integrations-n8n","integrations-metaapi","integrations-email","ai-health","system-health","system-logs","security-audit","system-flags","analytics-users","analytics-trading","analytics-ai","analytics-revenue","billing-overview","trading-accounts","trading-trades"}
        for rt in sorted(expected):
