...
// =====================================================================
// ۲.۵) Admin v2.2 shell — pass-through تک‌فایلی (آینهٔ قانون staging)
// =====================================================================
// دقیقاً مانند قانون ^admin/v2/index\.html$ در .htaccess استیجینگ: این فایل
// فیزیکی بیرون localized/** است و باید مستقیم سرو شود، نه از مسیر
// locale-router. (Production این مسیر را بسته‌بندی نمی‌کند — بدون تغییر.)
