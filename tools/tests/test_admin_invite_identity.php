...
if ($case === 'setup') {
    ...
    $pdo->exec('CREATE TABLE IF NOT EXISTS email_notifications (id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER NULL, email TEXT NULL, event_type TEXT NULL, subject TEXT NULL, sent INTEGER DEFAULT 0, created_at DATETIME DEFAULT CURRENT_TIMESTAMP)');
